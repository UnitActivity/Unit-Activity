...
class EditNotifikasiUKMPage extends StatefulWidget {
  final Map<String, dynamic> notification;

  const EditNotifikasiUKMPage({super.key, required this.notification});

  @override
  State<EditNotifikasiUKMPage> createState() => _EditNotifikasiUKMPageState();
}

class _EditNotifikasiUKMPageState extends State<EditNotifikasiUKMPage> {
  ...
  void _initializeForm() {
    // Pre-fill form with existing notification data
    _titleController.text = widget.notification['judul'] ?? '';
    _messageController.text = widget.notification['pesan'] ?? '';
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                Text(
                  'Notifikasi berhasil dikirim ulang ke ${_members.length} anggota!',
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Notifikasi akan dikirim ulang ke ${_members.length} anggota aktif',
                                  style: GoogleFonts.inter(
                                    fontSize: 13,
                            ...
                            children: [
                              ...
                              Expanded(
                                child: ElevatedButton.icon(
                                  ...
                                  label: Text(
                                    _isSending ? 'Mengirim...' : 'Kirim Ulang',
                                    style: GoogleFonts.inter(
                                      fontSize: 16,
                                      fontWeight: FontWeight.w600,
                                      color: Colors.white,
